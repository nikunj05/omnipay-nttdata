...
use Cx\Modules\checkout\omnipay\Omnipay\Omnipay;
    ...
    public function process($landingPage, \Cx\Modules\checkout\Model\Entity\Transaction $transaction, $landingPageParams = null)
    {
        ...
        if (!empty($availablePaymentMethods)) {    
            ...
            $postParams = array(
                ...
                //'notifyUrl' => 'https://dispatcher.payrexx.com.loc/nttdata/response.php',
            ...
            echo "<pre>"; print_r($response->getMessage()); exit;
            if ($response->isRedirect()) {
                ...
                // Redirect to nttdata payment gateway page
